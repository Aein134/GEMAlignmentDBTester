...
class RotationTest : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit RotationTest(const edm::ParameterSet&);
      ~RotationTest();
...
//
RotationTest::RotationTest(const edm::ParameterSet& p)
{
...
void
RotationTest::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void
RotationTest::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(RotationTest);
